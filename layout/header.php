...
<head>
    ...
    <script  src="public/script/jquery3.7.1.js"></script>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <!-- Bao gồm idTabs -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery.idTabs/1.1.0/jquery.idTabs.min.css" />
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.idTabs/1.1.0/jquery.idTabs.min.js"></script>
...
<body>
    <header class="header">
        <div class="top_header">
            <div class="container">
                <div class="rw_tophead">
                    <div class="c1_rw_tophead">
                        ...
                        <ul class="ul-default promo-list js-promo">
                            <li class="promo-item  see-block">
                                <a class="duration-300 line-clamp-2-new" href="#" title="[05.09 - 01.10] Càng mua càng giảm: mua 6 tặng 1, mua 10 tặng 2, mua 20 tặng 5">[05.09 - 01.10] Càng mua càng giảm: mua 6 tặng <span>1</span>, mua 10 tặng <span>2</span>, mua 20 tặng <span>5</span></a>
                            </li>
        ...
        <div class="main-header">
            <div class="container">
                <div class="box-header">
                    <div class="rw_item_mainhead">
                        <div class="c1_item_mainhead">
                            <a href="?mod=home&action=index" class="logo_wapper" title="Sudes Nest">
                                <img  src="public/images/logo.webp" alt="" class="img_logo_main">
                            </a>
                        </div>
                        <div class="c2_item_mainhead">
                            <div class="list_search_header">
                                <form action="/search" method="get" class="header-search-form input-group search-bar">
                                    <input type="text" name="query" required class="input-group-field auto-search search-auto form-control" placeholder="Tìm sản phẩm...">
                        ...
                        <div class="c3_item_mainhead">
                            <div class="header_store">
                                <a href="cua-hang.html" title="Cửa hàng">
                                    <span class="box-icon">
                            ...
                            <div class="header_favorite">
                                <a href="ds-yeu-thich.html" title="Danh sách yêu thích">
                                    <span class="box-icon">
                            ...
                            <div class="header_account">
                                <a href="" class="account" aria-label="Tài khoản" title="Tài khoản">
                                    <span class="box-icon">
                                    ...
                                    <svg class="arrown" width="30" height="30" viewBox="0 0 8 17" fill="none" xmlns="http://www.w3.org/2000/svg"> 
                                        <path d="M7.13382 7.1278L7.13379 7.12777L0.512271 0.509686L0.795057 0.226752L0.51227 0.509685C0.512123 0.509538 0.51201 0.509431 0.511927 0.509356L7.13382 7.1278ZM7.13382 7.1278C7.62239 7.61603 7.622 8.40641 7.13301 8.89414L7.13298 8.89417L0.502368 15.5089C0.50222 15.509 0.502106 15.5091 0.502022 15.5092C0.501841 15.5092 0.501547 15.5093 0.501149 15.5093C0.500827 15.5093 0.500574 15.5093 0.500392 15.5092L7.13055 8.89499C7.13056 8.89498 7.13057 8.89497 7.13058 8.89495C7.61976 8.407 7.62011 7.61541 7.13138 7.12699L7.13382 7.1278Z"></path>
                                    </svg>
                                </a>
                                <ul>
                                    <li class="li-account">
                                        <a rel="nofollow" href="dang-nhap.html" title="Đăng nhập">
                                    ...
                                    <div class="CartHeaderContainer">
                                        <div class="cart-message">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 201.387 201.387" style="enable-background:new 0 0 201.387 201.387;" xml:space="preserve">
                                                ...
                                                <g> 
                                                    <g> 
                                                        <path d="M179.197,64.679c-0.094-1.814-1.592-3.238-3.41-3.238H25.6c-1.818,0-3.316,1.423-3.41,3.238l-6.827,133.12    c-0.048,0.934,0.29,1.848,0.934,2.526c0.645,0.677,1.539,1.062,2.475,1.062h163.84c0.935,0,1.83-0.384,2.478-1.062    c0.643-0.678,0.981-1.591,0.934-2.526L179.197,64.679z M22.364,194.56l6.477-126.293h143.701l6.477,126.293H22.364z"></path> </g> </g> <g> <g> <path d="M126.292,75.093c-5.647,0-10.24,4.593-10.24,10.24c0,5.647,4.593,10.24,10.24,10.24c5.647,0,10.24-4.593,10.24-10.24    C136.532,79.686,131.939,75.093,126.292,75.093z M126.292,88.747c-1.883,0-3.413-1.531-3.413-3.413s1.531-3.413,3.413-3.413    c1.882,0,3.413,1.531,3.413,3.413S128.174,88.747,126.292,88.747z">
                                                        </path> 
                                                    </g> 
                                                </g> 
                                                <g> 
        ...
        <div class="header-menu">
            <div class="container">
                <div class="navigation">
                    ...
                    <div class="rw_menu">
                        <div class="c1_rw_menu">
                            <div class="title_rw_menu">
                            ...
                            <div class="sudes-list-cate" data-section="header_nav_cate"> 
                                    <ul class="sudes-main-cate">
                                        <?php 
                                            $list_danhmuc_sp = get_list_categories();
                                            foreach($list_danhmuc_sp as $danhmuc_sp){
                                                if ($danhmuc_sp['cap'] == 2 && $danhmuc_sp['kieu'] == 2 && $danhmuc_sp['hienthi'] == 2 ) {
                                        ?>
                                            
                                        <li class="sudes-main-cate-has-child menu-item-count <?php 
                                                $list_danhmuc_lv3 = get_list_categories_by_catid_cha($danhmuc_sp['danhmuc_id']);
                                                if(!empty($list_danhmuc_lv3)){
                                                    echo 'icon_style';
                                                }
                                            ?>">
                                            <a href="" title="Tổ yến">
                                                <img class="lazyload"  src="public/images/index-cate-icon-1.webp" data- src="public" alt="Tổ yến" />
                                                <?php 
                                                    echo $danhmuc_sp['ten_danhmuc'];
                                                ?>
                                            </a>
                                            ...
                                            <ul class="menu-child sub-menu sudes-sub-mega-menu">
                                                <?php 
                                                    $list_danhmuc_lv3 = get_list_categories_by_catid_cha($danhmuc_sp['danhmuc_id']);
                                                    foreach($list_danhmuc_lv3 as $danhmuc_sp_lv3){
                                                ?>
                                                <li class="sudes-main-cate-has-child clearfix">
                                                    <a class="name-sudes-main-cate" href="" title="">
                                                        <?php echo $danhmuc_sp_lv3['ten_danhmuc']?>
                                                    </a>
                                                    <i class="open_mnu down_icon"></i>
                                                    <ul class="menu-child menu-child-2 sub-menu clearfix">
                                                        <?php 
                                                            $list_danhmuc_lv4 = get_list_categories_by_catid_cha($danhmuc_sp_lv3['danhmuc_id']);
                                                            foreach($list_danhmuc_lv4 as $danhmuc_sp_lv4){
                                                        ?>
                                                        <li>
                                                            <a href="" title=""><?php echo $danhmuc_sp_lv4['ten_danhmuc']?></a>
                                                        </li>
                                                        <?php }?>
                                                    </ul>
                                                </li>
                        ...
                        <div class="c2_rw_menu">
                            <div class="col_menu">
                                <ul class="nav_menu">
                                    <li class="nav-item">
                                        <a href="?mod=home&action=index" class="nav_link">
                                            Trang chủ
                                        </a>
                                    </li>
                                    <?php 
                                        $list_danhmuc = get_list_categories();
                                        foreach($list_danhmuc as $danhmuc_sp){
                                            if ($danhmuc_sp['cap'] == 1){
                                    ?>
                                    <li class="nav-item">
                                        <a href="?mod=home&action=loadmenu&danhmuc_id=<?php echo $danhmuc_sp['danhmuc_id']?>" class="nav_link">
                                            <?php echo $danhmuc_sp['ten_danhmuc']?>
                                            <?php 
                                                $list_danhmuc_lv2 = get_list_categories_by_catid_cha($danhmuc_sp['danhmuc_id']);
                                                if (!empty($list_danhmuc_lv2)){
                                            ?>
                                        ...
                                        <ul class="dropdown-menu">
                                            <?php 
                                                foreach($list_danhmuc_lv2 as $danhmuc_sp_lv2){
                                                    if($danhmuc_sp_lv2['hienthi'] == 2){
                                            ?>
                                            <li class="dropdown-submenu nav-item-lv2 has-childs2">
                                                <a class="nav-link" href="?mod=home&action=loadmenu&danhmuc_id=<?php echo $danhmuc_sp_lv2['danhmuc_id']?>" title="">
                                                    <?php echo $danhmuc_sp_lv2['ten_danhmuc']?>
                                                    <?php 
                                                        $list_danhmuc_lv3 = get_list_categories_by_catid_cha($danhmuc_sp_lv2['danhmuc_id']);
                                                        if (!empty($list_danhmuc_lv3)){
                                                    ?>
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="nav-item-lv3">
                                                        <a class="nav-link" href="?mod=home&action=loadmenu&danhmuc_id=<?php echo $danhmuc_sp_lv3['danhmuc_id']?>" title=""><?php echo $danhmuc_sp_lv3['ten_danhmuc']?></a>
                                                    </li>
                                                    <?php }?>
                                                </ul>
                                                <?php } ?>
                                    ...
                                    <li class="nav-item">
                                        <a href="lien-he.html" class="nav_link">
                                            Liên hệ
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <div class="button-promo">
                                <a href="/san-pham-khuyen-mai" title="Hot deal" class="duration-300">
                                    <img  src="//bizweb.dktcdn.net/100/506/650/themes/944598/assets/btn_promotion_icon.png?1717814629369" data- src="public//bizweb.dktcdn.net/100/506/650/themes/944598/assets/btn_promotion_icon.png?1717814629369" alt="Hot deal" class="lazyload loaded">
                                    <span>Hot deal</span>
                                </a>
                            </div>
                        </div>
